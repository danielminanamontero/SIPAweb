...
### BITÁCORA - CERRADA - 20260214 184616
...
Pregunta: He comprobado y verificado y realizo commit de la versión 1.4.4 sobre-mi.html ok

- Publicado : <https://danielminanamontero.github.io/SIPAweb/>

#### Plan de trabajo para crear la transición de páginas, crear y publicar sobre-mi

- La transición se ejecuta con la creación y el enlace a páginas .md creadas por sipaweb.py se han creado clases especificas y los enlaces dirigen a su página .html creada automaticamente, sobre-mi, proyectos..., la página sobre-mi, esta creada y publicada en el enlace de arriba, pasamos a la página proyectos.

#### Cerrada 18/02/2026 12:01:44
